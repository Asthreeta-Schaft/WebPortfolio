...
export function Room(props) {
  const { nodes, materials } = useGLTF("/WebPortfolio/models/optimized-room.glb");
  const screensRef = useRef();
  const matcapTexture = useTexture("/WebPortfolio/images/textures/mat1.png");
...
useGLTF.preload("/WebPortfolio/models/optimized-room.glb");